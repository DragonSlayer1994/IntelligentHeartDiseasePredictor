...
class Prediction:
    ...
    def hdPrediction(request):
        ...
        userInputs = [age, sex, cp, trestbps, chol, fbs, restecg, thalach, exang, oldpeak, slope, ca, thal]
        if age is None:
            print("its null")
        else:
            ...
            accuracy1=[]
            clf = pickle.load(open('radomForest.pickle', 'rb'))
    ...
    def forest(request):
        ...
        with open('radomForest.pickle', 'wb') as f:
            pickle.dump(clf, f)

        pickle_in = open('radomForest.pickle', 'rb')
        ...
        prediction = clf.predict([testing, testing1])
